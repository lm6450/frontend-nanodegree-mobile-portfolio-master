...
// used an if loop to determine the number of pizzas needed in the backgroung (backPizzas) depending on the size of the screen and related to column width of bootstrap layout
